...
revoke all on sequence public.delivery_partner_rider_code_seq from public, anon, authenticated;
grant usage, select on sequence public.delivery_partner_rider_code_seq to service_role;
