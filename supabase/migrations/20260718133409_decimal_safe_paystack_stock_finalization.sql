-- Preserve loose/decimal quantities during verified Paystack stock deduction.
-- The previous function summed order item quantities as integer, which could
-- round/truncate loose purchases before stock validation and ledger insertion.
