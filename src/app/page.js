...
function MobileCategories({ categories, activeCategory, counts }) {
  return (
...
function TabletCategoryTabs({ categories, activeCategory, counts }) {
  return (
...
function DesktopSidebar({ categories, activeCategory, counts, sidebarRef, style }) {
  return (
    <aside
      ref={sidebarRef}
