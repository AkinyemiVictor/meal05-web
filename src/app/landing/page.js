...
const values = [
  [IconBolt, "Scheduled delivery", "24-hour or 48-hour", "orange"],
...
const steps = [
  ...
  ["03", IconTruckDelivery, "Scheduled delivery", "Choose a 24-hour or 48-hour delivery window at checkout."],
];
const products = [
...
export const metadata = {
  title: "Meal05 — Market-fresh groceries, delivered",
  description: "Fresh groceries delivered within Meal05's Ibadan launch area.",
...
export default function LandingPage() {
  return <main id="top" className={styles.page}>
    ...
    <section className={styles.finalWrap}><div className={styles.final}><i/><i/><h2>Your market run,<br/>handled.</h2><p>Create a free account and schedule your first basket delivery.</p><div><Link href="/home">Start shopping <IconArrowRight/></Link><Link href="/categories">Browse categories</Link></div></div></section>

    <footer className={styles.footer}><div className={styles.footerGrid}><div><Link href="/landing#top" className={styles.footerLogo}><Image src="/assets/logo/MEAL05 NEW LOGO-01.png" alt="Meal05" width={145} height={52}/></Link><p>Market-fresh groceries delivered within our Ibadan launch area. Handpicked, priced fairly, and delivered in your chosen schedule.</p><div className={styles.socials}><a href="https://wa.me/2348118287047" target="_blank" rel="noreferrer" aria-label="Chat with Meal05 on WhatsApp"><IconBrandWhatsapp/></a><a href="https://x.com/meal05_nigeria" target="_blank" rel="noreferrer" aria-label="Meal05 on X"><IconBrandX/></a><a href="https://www.instagram.com/meal05.nigeria/" target="_blank" rel="noreferrer" aria-label="Meal05 on Instagram"><IconBrandInstagram/></a></div></div>
