...
export const ADMIN_ROLE_DEFINITIONS = [
  {
    ...
    label: "Admin",
    rank: 1,
    permissions: ["view_admin_workspace", "view_staff_directory", "view_admin_logs"],
  },
  {
    value: "super_admin",
    label: "Super Admin",
...
export const isAdminWorkspaceRole = (value, isAdmin = false) => normalizeAdminRole(value, isAdmin) != null;
